package online.danbao.StudentInfoApplication.db;
...
import online.danbao.StudentInfoApplication.App;
import online.danbao.StudentInfoApplication.utils.FileUtils;

public class DBAdapter extends SQLiteOpenHelper {

    private static final String TAG = online.danbao.StudentInfoApplication.db.DBAdapter.class.getSimpleName();
    ...
    private volatile static online.danbao.StudentInfoApplication.db.DBAdapter dbAdapter;
     ...
     * @return DBAdapter
     */
    public static online.danbao.StudentInfoApplication.db.DBAdapter getInstance(Context context) {
        if (dbAdapter == null) {
            synchronized (online.danbao.StudentInfoApplication.db.DBAdapter.class) {
                if (dbAdapter == null) {
                    dbAdapter = new online.danbao.StudentInfoApplication.db.DBAdapter(context);
                }
            }
        }
        return dbAdapter;
